...
def search_firewalls(source_ip_input,destination_ip_input):
    try:
        print("printing",source_ip_input,destination_ip_input)
        # Validate IP inputs
        ...
        if  source_ip_input!="any":
            ...
            print("SourceInput",source_ip,src_subnet)
        ...
        # Check if src_subnet or dst_subnet is 0.0.0.0
        if src_subnet == "0.0.0.0/0":
            src_firewall = "Not Found"
            src_source_zone =  "Not Found"
            src_destination_zone =  "Not Found"
            

        if dst_subnet == "0.0.0.0/0":
            dst_firewall = "Not Found" 
            dst_destination_zone = "Not Found"  
            dst_source_zone =  "Not Found"        
        if src_firewall != dst_firewall and src_destination_zone==None and dst_source_zone:
            if src_firewall:
                src_destination_zone = "OutsideToSP"
            if dst_firewall:
                dst_source_zone = "OutsideToSP"
        print(src_firewall,src_source_zone,src_destination_zone,dst_firewall) 
        return [src_firewall,src_source_zone,src_destination_zone,dst_firewall,dst_source_zone,dst_destination_zone,src_subnet,dst_subnet]
